...
export default defineConfig({
        ...
        resolve: {
                alias: {
                        ...
                        // Same issue for zxcvbn-ts — conditions:['browser'] skips
                        // its 'import' condition. Alias to ESM entry directly.
                        'zxcvbn-ts': path.resolve(__dirname, 'node_modules/zxcvbn-ts/dist/esm/index.js')
                },
                conditions: ['browser']
        }
});
