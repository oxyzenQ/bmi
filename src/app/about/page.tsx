  ...
  return (
    <div className="min-h-screen py-8">
      <div className="space-container max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="space-container">
            <div className="text-center">
              <i className="fa-solid fa-calculator text-4xl text-blue-400 mb-4"></i>
          ...
          <div className="space-container">
            <div className="text-center">
              <i className="fa-solid fa-mobile-alt text-4xl text-purple-400 mb-4"></i>
              <h3 className="text-xl font-semibold text-white mb-2">
                Mobile Responsive
              </h3>
              <p className="text-gray-300">
          ...
          <div className="space-container">
            <div className="text-center">
              <i className="fa-solid fa-palette text-4xl text-yellow-400 mb-4"></i>
              <h3 className="text-xl font-semibold text-white mb-2">
                Space Theme
              </h3>
              <p className="text-gray-300">
          ...
          <div className="space-container">
            <div className="text-center">
              <i className="fa-solid fa-bolt text-4xl text-purple-400 mb-4"></i>
              <h3 className="text-xl font-semibold text-white mb-2">
                Fast & Lightweight
              </h3>
              <p className="text-gray-300">
        ...
        <div className="space-container mb-12">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-300">
              <div>
                <h4 className="text-lg font-semibold text-white mb-2">What is BMI?</h4>
                <p className="mb-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-white mb-2">BMI Categories</h4>
        ...
        <footer className="mt-16 text-center text-sm text-gray-400 border-t border-gray-600 pt-8">
          <p>
